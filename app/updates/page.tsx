...
export default function Updates() {
  return (
    <div className="h-full w-full">
      <main>
        <PageHeader
          title="Projectnieuws en voortgang"
          subheader="Ontdek de laatste updates over onze vastgoedontwikkelingen. Transparante rapportages en beeldmateriaal laten zien hoe jouw investering zich ontwikkelt: van fundering tot finale afwerking."
          subject=""
        />
        <PageSubHeader
          smallTitleTop="Projecten"
          iconName="Construction"
          title="Alle updates aangaande lopende projecten:"
        />
        <h1>Alle Updates</h1>
      </main>
    </div>
