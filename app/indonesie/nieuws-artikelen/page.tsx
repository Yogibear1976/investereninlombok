  ...
  return (
    <div className="h-full w-full">
      <main>
        <PageHeader
          title="Indonesie"
          subheader="Hier nog wat."
          subject="Nieuws artikelen"
        />
        <div className="container mx-auto">
          <h1>
            Nieuws artikelen over het investeringsklimaat in Indonesie,
            veranderingen over PT PMA, belastingen, etc. Tip. Haal veel van
            LinkedIn.
          </h1>
        </div>
      </main>
